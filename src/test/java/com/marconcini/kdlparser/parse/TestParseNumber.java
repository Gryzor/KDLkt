...
import com.marconcini.kdlparser.TestUtil;
...
public class TestParseNumber {
    ...
    public static List<Object[]> getCases() {
        return Stream.of(
                ...
                new Object[]{"-10", KDLNumber.from(-10, 10)},
                new Object[]{"+10", KDLNumber.from(10, 10)},
                new Object[]{"1.0", KDLNumber.from("1.0", 10)},
                new Object[]{"1e10", KDLNumber.from("1e10", 10)},
                new Object[]{"1e+10", KDLNumber.from("1e10", 10)},
                new Object[]{"1E+10", KDLNumber.from("1e10", 10)},
                new Object[]{"1e-10", KDLNumber.from("1e-10", 10)},
                new Object[]{"-1e-10", KDLNumber.from("-1e-10", 10)},
                new Object[]{"+1e-10", KDLNumber.from("1e-10", 10)},
    ...
    public void doTest() throws IOException {
        ...
        try {
            final KDLNumber str = TestUtil.parser.parseNumber(context, null);
