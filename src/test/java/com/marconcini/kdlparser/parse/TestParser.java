...
import static com.marconcini.kdlparser.TestUtil.parser;
import static com.marconcini.kdlparser.TestUtil.throwsException;
...
public class TestParser {
    ...
    public void test_arg_type() {
        ...
        assertThat(parser.parse("node (type)\"val\""), equalTo(doc(node("node", list(KDLString.from("val","type"))))));
        assertThat(parser.parse("node (type)r\"val\""), equalTo(doc(node("node", list(KDLString.from("val", "type"))))));
        assertThat(parser.parse("node (type)10"), equalTo(doc(node("node", list(KDLNumber.from(10, "type"))))));
        assertThat(parser.parse("node (\"type\")10"), equalTo(doc(node("node", list(KDLNumber.from(10, "type"))))));
        assertThat(parser.parse("node (r\"type\")10"), equalTo(doc(node("node", list(KDLNumber.from(10,"type"))))));
        assertThat(parser.parse("node (\"\")10"), equalTo(doc(node("node", list(KDLNumber.from(10,""))))));
        assertThat(parser.parse("node (type)0x10"), equalTo(doc(node("node", list(KDLNumber.from(16, 16, "type"))))));
        assertThat(parser.parse("node (type)0o10"), equalTo(doc(node("node", list(KDLNumber.from(8, 8, "type"))))));
        assertThat(parser.parse("node (type)0b10"), equalTo(doc(node("node", list(KDLNumber.from(2, 2, "type"))))));
        assertThat(parser.parse("node (type)1.0E2"), equalTo(doc(node("node", list(KDLNumber.from(new BigDecimal("1.0E2"), 10, "type"))))));
        assertThat(parser.parse("node (type)10.1"), equalTo(doc(node("node", list(KDLNumber.from(new BigDecimal("10.1"), 10, "type"))))));
        assertThat(parser.parse("node (type)true"), equalTo(doc(node("node", list(new KDLBoolean(true, "type"))))));
        assertThat(parser.parse("node (type)false"), equalTo(doc(node("node", list(new KDLBoolean(false, "type"))))));
        assertThat(parser.parse("node (type)null"), equalTo(doc(node("node", list(new KDLNull("type"))))));
    ...
    public void test_property_type() {
        ...
        assertThat(parser.parse("node key=(type)\"val\""), equalTo(doc(node("node", map("key", KDLString.from("val", "type"))))));
        assertThat(parser.parse("node key=(\"type\")\"val\""), equalTo(doc(node("node", map("key", KDLString.from("val", "type"))))));
        assertThat(parser.parse("node key=(r\"type\")\"val\""), equalTo(doc(node("node", map("key", KDLString.from("val", "type"))))));
        assertThat(parser.parse("node key=(\"\")\"val\""), equalTo(doc(node("node", map("key", KDLString.from("val", ""))))));
        assertThat(parser.parse("node key=(type)10"), equalTo(doc(node("node", map("key", KDLNumber.from(10, "type"))))));
        assertThat(parser.parse("node key=(type)true"), equalTo(doc(node("node", map("key", new KDLBoolean(true, "type"))))));
        assertThat(parser.parse("node key=(type)false"), equalTo(doc(node("node", map("key", new KDLBoolean(false, "type"))))));
        assertThat(parser.parse("node key=(type)null"), equalTo(doc(node("node", map("key", new KDLNull("type"))))));
